...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="jingdi_bw1_spread_10", help="name of the experiment")
    ...
    parser.add_argument("--benchmark-dir", type=str, default="/Users/Chris/Desktop/JD_MADDPG_10agents/maddpg/benchmark_files/", help="directory where benchmark data is saved")
    parser.add_argument("--plots-dir", type=str, default="/Users/Chris/Desktop/JD_MADDPG_10agents/maddpg/learning_curves/", help="directory where plot data is saved")
...
#        g3Save = []
        ...
        while True:
            ...
            for obs in obs_n:
                ...
                group5 = []
                group6 = []
                group1.append([obs[0], obs[2], obs[0], obs[2], obs[0], obs[2] , obs[0], obs[2], obs[0], obs[2], obs[0], obs[2], obs[0], obs[2], obs[0], obs[2], obs[0], obs[2], obs[0]])
                group2.append([obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1], obs[3], obs[1]])
                group3 = [obs[i] for i in range(42, 77, 2)]
                group3.append(0.0)
                group3 = [group3]
                group4 = [obs[i] for i in range(43, 78, 2)]
                group4.append(0.0)
                group4 = [group4]
                group5 = [obs[i] for i in range(4, 41, 2)]
                group6 = [obs[i] for i in range(5, 42, 2)]
                group5 = [group5]
                group6 = [group6]
